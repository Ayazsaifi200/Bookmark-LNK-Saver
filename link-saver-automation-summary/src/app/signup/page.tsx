        ...
        <div className="card p-8 shadow-lg animate-fadeIn">
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-6">
              <div className="h-16 w-16 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center animate-float">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Start saving links with automatic summaries
            </p>
          </div>
